...
@Component
class TSChunkDownloadLatency : BaseMetric {

    private lateinit var measureMap: MeasureMap
    private val LATENCY_MS = MeasureLong.create(
            "front_ts_chunk_download_latency",
            "The TS chunk download latency in milliseconds",
            "ms")
    ...
    override fun initialize() {
        ...
        val view: View = View.create(
                View.Name.create("front_ts_chunk_download_latency"),
                "The TS chunk download latency in milliseconds",
                LATENCY_MS,
